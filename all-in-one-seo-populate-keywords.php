...
Bitbucket Plugin URI: https://bitbucket.org/webspec/all-in-one-seo-populate-keywords
*/
...
$config = array(
    ...
    'proper_folder_name' => 'all-in-one-populate-keywords', // this is the name of the folder your plugin lives in
    'api_url' => 'https://api.github.com/repos/ethanclevenger91/all-in-one-populate-keywords', // the github API url of your github repo
    'raw_url' => 'https://raw.github.com/ethanclevenger91/all-in-one-populate-keywords/master', // the github raw url of your github repo
    'github_url' => 'https://github.com/ethanclevenger91/all-in-one-populate-keywords', // the github url of your github repo
    'zip_url' => 'https://github.com/ethanclevenger91/all-in-one-populate-keywords/zipball/master', // the zip url of the github repo
...
$WP_GitHub_Updater = new WP_GitHub_Updater($config);
