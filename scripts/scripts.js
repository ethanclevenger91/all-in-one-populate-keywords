jQuery(document).ready(function($) {
	$('.keywords-wrapper').on('click', '.remove-this-key', function() {
...
function addInput() {
	var $input = jQuery('<div class="pop-key-input-wrap sliding-in"><label class="keyword-label">Keyword:</label><input class="keyword-input" name="keywords[]" type="text" value=""><button type="button" class="remove-this-key button button-secondary">Remove This Key</button></div>');
